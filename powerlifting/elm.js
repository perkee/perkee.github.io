...
var author$project$Column$Allometric = {$: 'Allometric'};
var author$project$Column$BodyKilos = {$: 'BodyKilos'};
var author$project$Column$BodyPounds = {$: 'BodyPounds'};
var author$project$Column$Gender = {$: 'Gender'};
var author$project$Column$IPF = {$: 'IPF'};
var author$project$Column$Lift = {$: 'Lift'};
var author$project$Column$LiftedKilos = {$: 'LiftedKilos'};
var author$project$Column$LiftedPounds = {$: 'LiftedPounds'};
var author$project$Column$McCulloch = {$: 'McCulloch'};
var author$project$Column$ScaledAllometric = {$: 'ScaledAllometric'};
var author$project$Column$Wilks = {$: 'Wilks'};
...
var author$project$Column$initColumns = _List_fromArray(
	[author$project$Column$Gender, author$project$Column$Lift, author$project$Column$LiftedKilos, author$project$Column$BodyKilos, author$project$Column$LiftedPounds, author$project$Column$BodyPounds, author$project$Column$Wilks, author$project$Column$Allometric, author$project$Column$IPF, author$project$Column$McCulloch, author$project$Column$ScaledAllometric]);
var author$project$Feat$GNC = {$: 'GNC'};
var author$project$Feat$LBM = {$: 'LBM'};
var author$project$Feat$Raw = {$: 'Raw'};
var author$project$Feat$Total = {$: 'Total'};
var elm$core$Maybe$Nothing = {$: 'Nothing'};
var author$project$Main$initFloatField = {input: '', value: elm$core$Maybe$Nothing};
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{age: author$project$Main$initFloatField, bodyMass: author$project$Main$initFloatField, bodyUnit: author$project$Feat$LBM, bodyUnitState: rundis$elm_bootstrap$Bootstrap$Dropdown$initialState, columns: author$project$Column$initColumns, equipment: author$project$Feat$Raw, feats: elm$core$Array$empty, gender: author$project$Feat$GNC, lift: author$project$Feat$Total, liftedMass: author$project$Main$initFloatField, liftedUnit: author$project$Feat$LBM, liftedUnitState: rundis$elm_bootstrap$Bootstrap$Dropdown$initialState},
		elm$core$Platform$Cmd$none);
};
var author$project$Main$SetLiftedUnitState = function (a) {
	return {$: 'SetLiftedUnitState', a: a};
};
...
var author$project$Main$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				A2(rundis$elm_bootstrap$Bootstrap$Dropdown$subscriptions, model.liftedUnitState, author$project$Main$SetLiftedUnitState)
			]));
};
...
var author$project$Main$SavedFeat = F3(
	function (feat, index, note) {
		return {feat: feat, index: index, note: note};
	});
var elm$core$String$toFloat = _String_toFloat;
var author$project$Main$ffParse = function (str) {
	var _n0 = elm$core$String$toFloat(str);
	if (_n0.$ === 'Nothing') {
		return {input: str, value: elm$core$Maybe$Nothing};
	} else {
		var _new = _n0.a;
		return {
			input: str,
			value: elm$core$Maybe$Just(_new)
		};
	}
};
...
var author$project$Main$modelToFeat = function (m) {
	var _n0 = _Utils_Tuple2(m.bodyMass.value, m.liftedMass.value);
	if ((_n0.a.$ === 'Just') && (_n0.b.$ === 'Just')) {
		...
		return elm$core$Maybe$Just(
			{
				age: m.age.value,
				bodyKilos: A2(author$project$Feat$massToKilos, m.bodyUnit, bodyMass),
				bodyPounds: A2(author$project$Feat$massToPounds, m.bodyUnit, bodyMass),
				gender: m.gender,
				lift: m.lift,
				liftedKilos: A2(author$project$Feat$massToKilos, m.liftedUnit, liftedMass),
				liftedPounds: A2(author$project$Feat$massToPounds, m.liftedUnit, liftedMass)
			});
	} else {
		return elm$core$Maybe$Nothing;
	}
				...
				switch (msg.$) {
					case 'SetLiftedMass':
						...
						return _Utils_update(
							model,
							{
								liftedMass: author$project$Main$ffParse(s)
							});
					case 'SetLiftedUnit':
						var u = msg.a;
						return _Utils_update(
							model,
							{liftedUnit: u});
					case 'SetLiftedUnitState':
						var state = msg.a;
						return _Utils_update(
							model,
							{liftedUnitState: state});
					case 'SetBodyMass':
						var s = msg.a;
						return _Utils_update(
							model,
							{
								bodyMass: author$project$Main$ffParse(s)
							});
					case 'SetBodyUnit':
						var u = msg.a;
						return _Utils_update(
					...
					case 'SetAge':
						...
						return _Utils_update(
							model,
							{
								age: author$project$Main$ffParse(s)
							});
					case 'SaveFeat':
								...
								model,
								{
									feats: A2(
										...
										A3(
											...
											feat,
											elm$core$Array$length(model.feats),
											''),
										model.feats)
								});
						} else {
					...
					case 'ToggleColumn':
						var col = msg.a;
						var checked = msg.b;
						var newColumns = checked ? A2(elm$core$List$cons, col, model.columns) : A2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(elm$core$List$member, col, model.columns)),
...
var author$project$Scores$ipf = function (m) {
	if (elm$core$Basics$abs(m.liftedKilos) < 0.25) {
		return author$project$Scores$Ipf(0);
	} else {
		var scale = elm$core$Basics$mul(
			A2(elm$core$Basics$logBase, elm$core$Basics$e, m.bodyKilos));
		var _n0 = author$project$Scores$ipfCoefficients(m);
		if (_n0.$ === 'Just') {
			var cs = _n0.a;
			return author$project$Scores$Ipf(
				500 + ((100 * (m.liftedKilos - (scale(cs.c1) - cs.c2))) / (scale(cs.c3) - cs.c4)));
		} else {
...
var author$project$Scores$polynomialMultiply = F3(
	function (m, index, _const) {
		return _const * A2(elm$core$Basics$pow, m.bodyKilos, index);
	});
...
var author$project$Scores$mcCulloch = function (feat) {
	var _n0 = _Utils_Tuple2(
		A2(elm$core$Maybe$map, author$project$Scores$mcCullochFactor, feat.age),
		author$project$Scores$wilks(feat));
	if ((_n0.a.$ === 'Just') && (_n0.b.$ === 'Wilks')) {
		var scale = _n0.a.a;
		var score = _n0.b.a;
...
var author$project$Scores$scaledAllometric = function (m) {
	...
	if ((_n0.a.$ === 'Just') && (_n0.b.$ === 'Allometric')) {
		...
		switch (score.$) {
			...
			case 'ScaledAllometric':
				...
				return _Utils_update(
					record,
					{
						scaledAllometric: elm$core$Maybe$Just(s)
					});
			case 'Allometric':
				var s = score.a;
				return _Utils_update(
					record,
					{
						allometric: elm$core$Maybe$Just(s)
					});
			case 'Ipf':
				var s = score.a;
				return _Utils_update(
			...
			case 'McCulloch':
				...
				return _Utils_update(
					record,
					{
						mcCulloch: elm$core$Maybe$Just(s)
					});
			default:
				return record;
		}
...
var author$project$Scores$featToRecord = function (feat) {
	return A3(
		...
		{allometric: elm$core$Maybe$Nothing, feat: feat, ipf: elm$core$Maybe$Nothing, mcCulloch: elm$core$Maybe$Nothing, scaledAllometric: elm$core$Maybe$Nothing, wilks: elm$core$Maybe$Nothing},
...
var author$project$Dropdowns$Option = F3(
	function (value, label, valAttr) {
		return {label: label, valAttr: valAttr, value: value};
	});
...
var author$project$Dropdowns$opt = F2(
	function (current, option) {
		return A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$value(option.valAttr),
					elm$html$Html$Attributes$selected(
					_Utils_eq(current, option.value))
				]),
			_List_fromArray(
				[
		...
		return A2(
			...
			elm$core$Dict$fromList(
				A2(
					elm$core$List$map,
					function (option) {
						return _Utils_Tuple2(option.valAttr, option.value);
					},
					options)));
	});
...
var author$project$Main$SaveFeat = {$: 'SaveFeat'};
					...
					[
						...
						_List_fromArray(
							[
								...
								unitMsg(author$project$Feat$KG))
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(
								unitMsg(author$project$Feat$LBM))
							]),
						_List_fromArray(
							[
...
var rundis$elm_bootstrap$Bootstrap$Grid$Col$sm5 = A2(rundis$elm_bootstrap$Bootstrap$Grid$Internal$width, rundis$elm_bootstrap$Bootstrap$General$Internal$SM, rundis$elm_bootstrap$Bootstrap$Grid$Internal$Col5);
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														A3(author$project$Dropdowns$Option, author$project$Feat$Male, 'man', 'M'),
														A3(author$project$Dropdowns$Option, author$project$Feat$Female, 'woman', 'F'),
														A3(author$project$Dropdowns$Option, author$project$Feat$GNC, 'lifter', 'GNC')
													]),
												model.gender,
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														A3(author$project$Dropdowns$Option, author$project$Feat$Total, 'totalled', 'T'),
														A3(author$project$Dropdowns$Option, author$project$Feat$Squat, 'squatted', 'S'),
														A3(author$project$Dropdowns$Option, author$project$Feat$Bench, 'benched', 'B'),
														A3(author$project$Dropdowns$Option, author$project$Feat$Deadlift, 'deadlifted', 'D')
													]),
												model.lift,
															...
															[
																...
																rundis$elm_bootstrap$Bootstrap$Form$InputGroup$small(
																	A2(
																		...
																		_List_fromArray(
																			[
																				A4(author$project$Main$unitDropDown, model.liftedUnitState, author$project$Main$SetLiftedUnitState, model.liftedUnit, author$project$Main$SetLiftedUnit)
																			]),
															...
															[
																...
																rundis$elm_bootstrap$Bootstrap$Form$InputGroup$small(
																	A2(
																		...
																		_List_fromArray(
																			[
																				A4(author$project$Main$unitDropDown, model.bodyUnitState, author$project$Main$SetBodyUnitState, model.bodyUnit, author$project$Main$SetBodyUnit)
																			]),
																		rundis$elm_bootstrap$Bootstrap$Form$InputGroup$config(
																			rundis$elm_bootstrap$Bootstrap$Form$InputGroup$number(
																				_List_fromArray(
															...
															[
																...
																_List_fromArray(
																	[
																		...
																		rundis$elm_bootstrap$Bootstrap$Form$Input$value(model.age.input),
			...
			elm$core$List$concat(
				_List_fromArray(
					[
						...
						elm$core$List$map(
						author$project$Library$thrush(
							author$project$Scores$featToRecord(savedFeat.feat)))(
						A2(elm$core$List$map, author$project$Column$columnToRecordToText, cols))
					])));
	});
							...
							[
								...
								_List_fromArray(
									[
										...
										A2(author$project$Library$filterListByList, model.columns, author$project$Column$initColumns),
										model.feats)
									]))
							]))
					]))
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Bootstrap.Dropdown.StateRec":{"args":[],"type":"{ status : Bootstrap.Dropdown.DropdownStatus, toggleSize : Bootstrap.Utilities.DomHelper.Area, menuSize : Bootstrap.Utilities.DomHelper.Area }"},"Bootstrap.Utilities.DomHelper.Area":{"args":[],"type":"{ top : Basics.Float, left : Basics.Float, width : Basics.Float, height : Basics.Float }"}},"unions":{"Main.Msg":{"args":[],"tags":{"SetLiftedMass":["String.String"],"SetLiftedUnit":["Feat.MassUnit"],"SetLiftedUnitState":["Bootstrap.Dropdown.State"],"SetBodyMass":["String.String"],"SetBodyUnit":["Feat.MassUnit"],"SetBodyUnitState":["Bootstrap.Dropdown.State"],"SetGender":["Maybe.Maybe Feat.Gender"],"SetLift":["Maybe.Maybe Feat.Lift"],"SetAge":["String.String"],"SaveFeat":[],"SetNote":["Basics.Int","String.String"],"ToggleColumn":["Column.Column","Basics.Bool"],"SetEquipment":["Maybe.Maybe Feat.Equipment"]}},"Column.Column":{"args":[],"tags":{"BodyKilos":[],"LiftedKilos":[],"BodyPounds":[],"LiftedPounds":[],"Wilks":[],"ScaledAllometric":[],"Allometric":[],"IPF":[],"McCulloch":[],"Gender":[],"Lift":[]}},"Feat.Equipment":{"args":[],"tags":{"Raw":[],"SinglePly":[]}},"Feat.Gender":{"args":[],"tags":{"Male":[],"Female":[],"GNC":[]}},"Feat.Lift":{"args":[],"tags":{"Squat":[],"Bench":[],"Deadlift":[],"Total":[]}},"Feat.MassUnit":{"args":[],"tags":{"KG":[],"LBM":[]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Bootstrap.Dropdown.State":{"args":[],"tags":{"State":["Bootstrap.Dropdown.StateRec"]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Bootstrap.Dropdown.DropdownStatus":{"args":[],"tags":{"Open":[],"ListenClicks":[],"Closed":[]}}}}})}});}(this));